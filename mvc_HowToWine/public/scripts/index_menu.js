...
// const animatedMenu = document.querySelector('#demiCercle');

// window.addEventListener('scroll', () => {
//     const {scrollTop, clientHeight} = document.documentElement;
//     const topElementToTopViewport = animatedMenu.getBoundingClientRect().top;
//     if(scrollTop > (scrollTop + topElementToTopViewport).toFixed() - clientHeight * 0.8){
//         animatedMenu.classList.remove('resetMenu');
//         animatedMenu.classList.add('animatedMenu');
